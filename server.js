...
app.get('/win', function (request, response) {
    if(userData[0]!=''){
    model.updateRankings(userData[0],userData[1]+1,userData[2],userData[3], () => {
...
app.get('/loss', function (request, response) {
    if(userData[0]!=''){
    model.updateRankings(userData[0],userData[1],userData[2]+1,userData[3], () => {
...
app.get('/tie', function (request, response) {
    if(userData[0]!=''){
    model.updateRankings(userData[0],userData[1],userData[2],userData[3]+1, () => {
